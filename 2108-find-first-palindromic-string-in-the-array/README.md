...
<ul>
<li>Iterate through the elements in order. As soon as the current element is a palindrome, return it.</li>
<li>To check if an element is a palindrome, can you reverse the string?</li>
</ul>