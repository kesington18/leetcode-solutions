...
<ul>
<li>You can return an object with methods.</li>
<li>Initialize a variable for currentCount. Inside these methods, add the appropriate logic which mutates currentCount.</li>
</ul>